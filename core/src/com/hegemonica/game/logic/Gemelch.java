...
public class Gemelch {
    ...
    public Gemelch(Core game, int provCountWidth, int provCountHeight, Stage stage) {
        ...
        leftBottomProv.manualInitialization(false);
        rightBottomProv.manualInitialization(false);
        leftTopProv.manualInitialization(false);
        rightTopProv.manualInitialization(false);
